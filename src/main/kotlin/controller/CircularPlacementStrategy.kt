...
class CircularPlacementStrategy: Controller(), Representation {
    override public fun place(width: Double, height: Double, vertices: Collection<VertexView>) {
        if (vertices.isEmpty()) {
        ...
        val sorted = vertices.sortedBy { it.vertex.name.toString().toLowerCase() }
